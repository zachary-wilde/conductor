...
export function BottomNav({
  ...
  return (
    <nav className="flex border-t border-edge bg-bg-1 pb-[env(safe-area-inset-bottom)] md:hidden">
      {NAV.map((item) => {
...
export function SideRail({
  ...
  return (
    <nav className="hidden w-52 shrink-0 flex-col gap-1 border-r border-edge bg-bg-1 p-3 md:flex">
